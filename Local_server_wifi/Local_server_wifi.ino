...
const char* serverUrl = "http://121.174.96.150:8080";  // Replace with your laptop's IP address and port
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    // Send data to server
    sendDataToServer(fsrValue1, fsrValue2, fsrValue3);  // Send sensor values to respective columns
...
void sendDataToServer(float value1, float value2, float value3) {
  HTTPClient http;
